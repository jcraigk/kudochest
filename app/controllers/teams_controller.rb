...
class TeamsController < ApplicationController
  ...
  def team_params
    params.require(:team).permit \
      ...
      :response_mode, :response_theme, :log_channel_rid, :tip_emoji, :jab_emoji, :ditto_emoji,
  ...
  def platform_team_params
    ...
    when 'discord' then team_params.except(:tip_emoji, :jab_emoji, :ditto_emoji, :join_channels)
    end
  end
